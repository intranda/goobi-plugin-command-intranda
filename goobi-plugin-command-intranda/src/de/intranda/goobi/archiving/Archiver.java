...
public class Archiver extends Thread {
    ...
    private static String backup_already_exists_error =
            "Zu diesem Vorgang existiert bereits ein Backup in diesem Pfad. Wenn Sie weitere Backups ausführen möchten, wenden Sie sich bitte an ihren Goobi-Administrator; oder aktivieren Sie die Option zur Verwendung datierter Archivordner.";
